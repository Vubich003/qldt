...
namespace QuanLyDienThoai
{
    public partial class frmDMHangHoa : Form
    {
        ...
        {
            string sql;
            sql = "SELECT * from tblHangDT";
            txtMaHang.Enabled = false;
            btnLuu.Enabled = false;
            btnBoQua.Enabled = false;
            LoadDataGridView();
            Functions.FillCombo(sql, cboMaHangDT, "MaHangDT", "TenHangDT");
            cboMaHangDT.SelectedIndex = -1;
            ResetValues();
        }
        ...
        private void LoadDataGridView()
        {
            ...
            dgvHang.Columns[2].HeaderText = "Mã Hãng";
        ...
        private void dgvHang_Click(object sender, EventArgs e)
        {
            ...
            MaHangDT = dgvHang.CurrentRow.Cells["MaHangDT"].Value.ToString();
            sql = "SELECT TenHangDT FROM tblHangDT WHERE MaHangDT=N'" + MaHangDT + "'";
            cboMaHangDT.Text = Functions.GetFieldValues(sql);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (cboMaHangDT.Text.Trim().Length == 0)
            {
                MessageBox.Show("Bạn phải nhập hãng điện thoại", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cboMaHangDT.Focus();
                return;
            }
            ...
            sql = "INSERT INTO tblHang(MaHang,TenHang,MaHangDT,SoLuong,DonGiaNhap, DonGiaBan,Anh,Ghichu) VALUES(N'"
                + txtMaHang.Text.Trim() + "',N'" + txtTenHang.Text.Trim() +
                "',N'" + cboMaHangDT.SelectedValue.ToString() +
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblHang SET TenHang=N'" + txtTenHang.Text.Trim().ToString() +
                "',MaHangDT=N'" + cboMaHangDT.SelectedValue.ToString() +
        ...
        {
            string sql;
            if ((txtMaHang.Text == "") && (txtTenHang.Text == "") && (cboMaHangDT.Text == ""))
            {
            ...
            if (cboMaHangDT.Text != "")
                sql += " AND MaHangDT LIKE N'%" + cboMaHangDT.SelectedValue + "%'";
            tblHang = Functions.GetDataToTable(sql);
            if (tblHang.Rows.Count == 0)
        ...
        {
            string sql;
            sql = "SELECT MaHang,TenHang,MaHangDT,SoLuong,DonGiaNhap,DonGiaBan,Anh,Ghichu FROM tblHang";
            tblHang = Functions.GetDataToTable(sql);
            dgvHang.DataSource = tblHang;
        }
